...
/** Content for any post */
export type Content = Entity & {
  __typename?: 'Content';
  /** The body of the content, in a valid, semantic, HTML fragment, or Markdown. Further markups may be supported in the future. For a full list of accepted HTML tags, see here. If you want your title to appear on the post page, you must also include it as part of the post content. */
  content: RichText;
  /** The excerpt of the content, a shortened version that gets published externally. */
...
export type ContentCreateInput = {
  ...
  /** Inline mutations for managing document localizations excluding the default locale */
  localizations?: InputMaybe<ContentCreateLocalizationsInput>;
  tags?: InputMaybe<Array<Scalars['String']['input']>>;
};

export type ContentCreateLocalizationDataInput = {
  content: Scalars['RichTextAST']['input'];
  excerpt?: InputMaybe<Scalars['RichTextAST']['input']>;
};

export type ContentCreateLocalizationInput = {
  /** Localization input */
  data: ContentCreateLocalizationDataInput;
  locale: Locale;
};

export type ContentCreateLocalizationsInput = {
  /** Create localizations for the newly-created document */
  create?: InputMaybe<Array<ContentCreateLocalizationInput>>;
};
...
export type ContentParent = Post | Project;
...
export type ContentUpdateInput = {
  ...
  excerpt?: InputMaybe<Scalars['RichTextAST']['input']>;
  /** Manage document localizations */
  localizations?: InputMaybe<ContentUpdateLocalizationsInput>;
  tags?: InputMaybe<Array<Scalars['String']['input']>>;
};

export type ContentUpdateLocalizationDataInput = {
  content?: InputMaybe<Scalars['RichTextAST']['input']>;
  excerpt?: InputMaybe<Scalars['RichTextAST']['input']>;
};

export type ContentUpdateLocalizationInput = {
  data: ContentUpdateLocalizationDataInput;
  locale: Locale;
};

export type ContentUpdateLocalizationsInput = {
  /** Localizations to create */
  create?: InputMaybe<Array<ContentCreateLocalizationInput>>;
  /** Localizations to delete */
  delete?: InputMaybe<Array<Locale>>;
  /** Localizations to update */
  update?: InputMaybe<Array<ContentUpdateLocalizationInput>>;
  upsert?: InputMaybe<Array<ContentUpsertLocalizationInput>>;
};
...
export type ContentUpdateManyInput = {
  ...
  localizations?: InputMaybe<ContentUpdateManyLocalizationsInput>;
  tags?: InputMaybe<Array<Scalars['String']['input']>>;
};

export type ContentUpdateManyLocalizationDataInput = {
  content?: InputMaybe<Scalars['RichTextAST']['input']>;
  excerpt?: InputMaybe<Scalars['RichTextAST']['input']>;
};

export type ContentUpdateManyLocalizationInput = {
  data: ContentUpdateManyLocalizationDataInput;
  locale: Locale;
};

export type ContentUpdateManyLocalizationsInput = {
  /** Localizations to update */
  update?: InputMaybe<Array<ContentUpdateManyLocalizationInput>>;
};
...
export type ContentUpsertLocalizationInput = {
  create: ContentCreateLocalizationDataInput;
  locale: Locale;
  update: ContentUpdateLocalizationDataInput;
};
...
export type Post = Entity & Node & {
  ...
  /** The content for a blog post */
  content?: Maybe<PostcontentUnion>;
  /** The time the document was created */
  createdAt: Scalars['DateTime']['output'];
  /** User that created this document */
  createdBy?: Maybe<User>;
  ...
  /** The ID used to reference the post on external platforms */
  externalId?: Maybe<Scalars['String']['output']>;
  /** The external publish status of the post. */
  externalPublishStatus: PublishStatus;
  /** The URL of the content on external platform */
...
export type PostCreateInput = {
  ...
  content?: InputMaybe<PostcontentUnionCreateOneInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
...
export type PostManyWhereInput = {
  ...
  content?: InputMaybe<PostcontentUnionWhereInput>;
  ...
  externalPublishStatus?: InputMaybe<PublishStatus>;
  /** All values that are contained in given list. */
  externalPublishStatus_in?: InputMaybe<Array<InputMaybe<PublishStatus>>>;
  /** Any other value that exists and is not equal to the given value. */
  externalPublishStatus_not?: InputMaybe<PublishStatus>;
  /** All values that are not contained in given list. */
  externalPublishStatus_not_in?: InputMaybe<Array<InputMaybe<PublishStatus>>>;
  externalUrl?: InputMaybe<Scalars['String']['input']>;
  /** All values containing the given string. */
...
export enum PostOrderByInput {
  ...
  ExternalPublishStatusAsc = 'externalPublishStatus_ASC',
  ExternalPublishStatusDesc = 'externalPublishStatus_DESC',
...
export type PostUpdateInput = {
  canonicalUrl?: InputMaybe<Scalars['String']['input']>;
  content?: InputMaybe<PostcontentUnionUpdateOneInlineInput>;
  externalId?: InputMaybe<Scalars['String']['input']>;
  externalPublishStatus?: InputMaybe<PublishStatus>;
  externalUrl?: InputMaybe<Scalars['String']['input']>;
  /** Manage document localizations */
...
export type PostcontentUnion = Content;

export type PostcontentUnionConnectInput = {
  Content?: InputMaybe<ContentConnectInput>;
};

export type PostcontentUnionCreateInput = {
  Content?: InputMaybe<ContentCreateInput>;
};

export type PostcontentUnionCreateManyInlineInput = {
  /** Create and connect multiple existing PostcontentUnion documents */
  create?: InputMaybe<Array<PostcontentUnionCreateInput>>;
};

export type PostcontentUnionCreateOneInlineInput = {
  /** Create and connect one PostcontentUnion document */
  create?: InputMaybe<PostcontentUnionCreateInput>;
};

export type PostcontentUnionCreateWithPositionInput = {
  Content?: InputMaybe<ContentCreateWithPositionInput>;
};

export type PostcontentUnionUpdateInput = {
  Content?: InputMaybe<ContentUpdateInput>;
};

export type PostcontentUnionUpdateManyInlineInput = {
  /** Create and connect multiple PostcontentUnion component instances */
  create?: InputMaybe<Array<PostcontentUnionCreateWithPositionInput>>;
  /** Delete multiple PostcontentUnion documents */
  delete?: InputMaybe<Array<PostcontentUnionWhereUniqueInput>>;
  /** Update multiple PostcontentUnion component instances */
  update?: InputMaybe<Array<PostcontentUnionUpdateWithNestedWhereUniqueAndPositionInput>>;
  /** Upsert multiple PostcontentUnion component instances */
  upsert?: InputMaybe<Array<PostcontentUnionUpsertWithNestedWhereUniqueAndPositionInput>>;
};

export type PostcontentUnionUpdateManyWithNestedWhereInput = {
  Content?: InputMaybe<ContentUpdateManyWithNestedWhereInput>;
};

export type PostcontentUnionUpdateOneInlineInput = {
  /** Create and connect one PostcontentUnion document */
  create?: InputMaybe<PostcontentUnionCreateInput>;
  /** Delete currently connected PostcontentUnion document */
  delete?: InputMaybe<Scalars['Boolean']['input']>;
  /** Update single PostcontentUnion document */
  update?: InputMaybe<PostcontentUnionUpdateWithNestedWhereUniqueInput>;
  /** Upsert single PostcontentUnion document */
  upsert?: InputMaybe<PostcontentUnionUpsertWithNestedWhereUniqueInput>;
};

export type PostcontentUnionUpdateWithNestedWhereUniqueAndPositionInput = {
  Content?: InputMaybe<ContentUpdateWithNestedWhereUniqueAndPositionInput>;
};

export type PostcontentUnionUpdateWithNestedWhereUniqueInput = {
  Content?: InputMaybe<ContentUpdateWithNestedWhereUniqueInput>;
};

export type PostcontentUnionUpsertWithNestedWhereUniqueAndPositionInput = {
  Content?: InputMaybe<ContentUpsertWithNestedWhereUniqueAndPositionInput>;
};

export type PostcontentUnionUpsertWithNestedWhereUniqueInput = {
  Content?: InputMaybe<ContentUpsertWithNestedWhereUniqueInput>;
};

export type PostcontentUnionWhereInput = {
  Content?: InputMaybe<ContentWhereInput>;
};

export type PostcontentUnionWhereUniqueInput = {
...
export type Project = Entity & Node & {
  ...
  /** The canonical URL of the post. If canonicalUrl was not specified in the creation of the post, this field will not be present. */
  canonicalUrl?: Maybe<Scalars['String']['output']>;
  /** The content for a project post */
  content?: Maybe<ProjectcontentUnion>;
  /** The time the document was created */
  createdAt: Scalars['DateTime']['output'];
  /** User that created this document */
  createdBy?: Maybe<User>;
  ...
  /** The ID to reference the post on an external platform */
  externalId?: Maybe<Scalars['String']['output']>;
  /** The external publish status of the project post */
  externalPublishStatus?: Maybe<PublishStatus>;
  /** The URL of the content on external platform */
  externalUrl?: Maybe<Scalars['String']['output']>;
  ...
  /** The period of time which the project was worked on. */
  period?: Maybe<Scalars['String']['output']>;
  /** The time the document was published. Null on documents in draft stage. */
  publishedAt?: Maybe<Scalars['DateTime']['output']>;
  /** User that last published this document */
  publishedBy?: Maybe<User>;
  /** The role you had in the project */
  ...
  /** System stage field */
  stage: Stage;
  /** The thumbnail image for the project */
  thumbnail: Asset;
  title: Scalars['String']['output'];
...
export type ProjectCreateInput = {
  canonicalUrl?: InputMaybe<Scalars['String']['input']>;
  content?: InputMaybe<ProjectcontentUnionCreateOneInlineInput>;
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
  /** desc input for default locale (en) */
...
export type ProjectManyWhereInput = {
  ...
  canonicalUrl_starts_with?: InputMaybe<Scalars['String']['input']>;
  /** All values in which the modular component is connected to the given models */
  content?: InputMaybe<ProjectcontentUnionWhereInput>;
  /** All values in which the union is empty. */
  content_empty?: InputMaybe<Scalars['Boolean']['input']>;
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than the given value. */
  ...
  tools?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array contains *all* items provided to the filter */
  tools_contains_all?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array does not contain any of the items provided to the filter */
  tools_contains_none?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array contains at least one item provided to the filter */
  tools_contains_some?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array does not contains *all* items provided to the filter or order does not match */
  tools_not?: InputMaybe<Array<Scalars['String']['input']>>;
  updatedAt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than the given value. */
  updatedAt_gt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than or equal the given value. */
...
export type ProjectUpdateInput = {
  canonicalUrl?: InputMaybe<Scalars['String']['input']>;
  content?: InputMaybe<ProjectcontentUnionUpdateOneInlineInput>;
  /** desc input for default locale (en) */
...
/** Publishing status of blog post */
...
export type GetPostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', id: string, title: string, stage: Stage, slug?: string | null, publishedAt?: string | null }> };
...
export type GetPostBySlugQuery = { __typename?: 'Query', post?: { __typename?: 'Post', id: string, title: string, stage: Stage, slug?: string | null, publishedAt?: string | null } | null };
