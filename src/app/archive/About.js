    ...
    <Layout>
      <Grid container spacing={4} className={classes.root}>
        ...
        <Grid item xs={12} sm={8} md={9}>
          ...
          <Typography color="secondary" variant="body2">
            I’m a UX Designer with expertise in web/graphic design, front-end web development, and
            video/animation production. I currently work at Rocket Dollar, a fintech company based
            in Austin, Texas.
            <br />
            <br />
            Rocket Dollar builds streamlined processes for opening and administrating self-directed
            retirement accounts, along with investment management tools to help investors track the
            performance of their assets.
            <br />
            <br />
            At Rocket Dollar, I’ve been responsible for developing our brand along with the design
            system that accompanies it. Along with branding, I designed and developed our website,
            and have worked with our talented development team to design and develop our
            application. Lastly, I’ve worked with our executive and sales and marketing teams to
            craft some of our presentations, marketing materials, and videos.
            <br />
            <br />
            {/* My tenor at Rocket Dollar has been a humbling experience, I’m surrounded by some of the most talented people 
                    ...
                    <br /><br /> */}
            Before Rocket Dollar, I was the Director of Account Management at BlueCheck, a digital
            age and identity verification company, the Community Development Manager at Candid.ly
            now Candidly.com, and a Techstars Associate at Techstars Austin.
            <br />
            <br />
